...
class HomeRefuelingWidget extends StatelessWidget {
  const HomeRefuelingWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<RefuelingProvider>(
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              trailing: Text(
                'R\$ ${refueling.pricePerLiter.toStringAsFixed(2)}',
              ),
            );
          },
        );
